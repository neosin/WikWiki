 ...
 * @return void
 */
function printBacklinksinPage($page){
	$blocked = array("Home_Page");
	if (!in_array(titleToId($page), $blocked)){

		//

		global $texy;
		$s = "<hr>This is a list of all pages that link to <b>$page<b>.\n";
